class BatchjobCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/SSYCloud/AssembleFlow/releases/download/v0.1.3/batchjob-cli-darwin-arm64.tar.gz"
      sha256 "36b0cade38ecef38041be8b53dafa0ee6c84c92bba5d7a6bbda901c2bd56d0e3"
    else
      url "https://github.com/SSYCloud/AssembleFlow/releases/download/v0.1.3/batchjob-cli-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/SSYCloud/AssembleFlow/releases/download/v0.1.3/batchjob-cli-linux-arm64.tar.gz"
      sha256 "c5f16019109ef8a810e521cfdebfb3bc94333a0e739fef04a89191c7a0f5fb9f"
    else
      url "https://github.com/SSYCloud/AssembleFlow/releases/download/v0.1.3/batchjob-cli-linux-amd64.tar.gz"
