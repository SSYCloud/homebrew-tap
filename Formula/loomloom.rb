class Loomloom < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/SSYCloud/loomloom/releases/download/v0.2.1/loomloom-darwin-arm64.tar.gz"
      sha256 "cac9e0178a396ec32a31f80a32cdf6bd8e1e0879b8288728f62ae239cdc352f7"
    else
      url "https://github.com/SSYCloud/loomloom/releases/download/v0.2.1/loomloom-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/SSYCloud/loomloom/releases/download/v0.2.1/loomloom-linux-arm64.tar.gz"
      sha256 "5b0515d27d247617ed1423f94cb176973f584af18ece4faae50bd7c180b66c5f"
    else
      url "https://github.com/SSYCloud/loomloom/releases/download/v0.2.1/loomloom-linux-amd64.tar.gz"
